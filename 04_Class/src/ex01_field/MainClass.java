...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// user1의 addr 필드를 생성 (Addrress 클래스 타입이기 때문에 반드시 new를 이용해 생성해야 한다)
		user1.addr = new Address();
		
		user1.addr.postcode = "54";
		...
		System.out.println("주소 : " + user1.addr.postcode + " " + user1.addr.jibunAddress + " " + user1.addr.roadAddress);
		...
		// user2의 addr 필드를 생성 (Addrress 클래스 타입이기 때문에 반드시 new를 이용해 생성해야 한다)
		user2.addr = new Address();
		
		user2.addr.postcode = "43212";
		...
		System.out.println("주소 : " + user2.addr.postcode + " " + user2.addr.jibunAddress + " " + user2.addr.roadAddress);
