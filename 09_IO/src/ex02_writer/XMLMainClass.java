...
public class XMLMainClass {
	...
	/*
	 	목표
	 	1. 경로
		 		C:\storage\product.xml	(dom 처리방식)
		 	2. 내용
		 		<products> // 부모
		 			<product> // 자식
		 				<model>세탁기</model> //더 낮은 자식
		 				<maker>삼성</maker>	      
		 				<price>100</price>	
		 			</product>
		 			<product>   *
		 				<model>냉장고</model>	// 태그 안에있는 텍스트를 textContent라고 한다 *
		 				<maker>LG</maker>
		 				<price>200</price>
		 			</product>
		 			<product>
	...
	public static void main(String[] args) {
		...
		try {
			...
			for(Map<String, Object> map : productList) {
				...
				price.setTextContent((int)map.get("price") + "");	// toString()은 거의 다 됨
