...
public class MainClass {
	...
	public static void ex01() {
		...
		// File.separator : 플랫폼에 따라서 자동으로 경로 구분자를 사용한다. (윈도우 \\, 리눅스 //)
		
		// 디렉터리 관련 필수 작업
		
		File dir = new File("C:" + File.separator + "storage");	// C드라이브 아래 storage 폴더를 의미
		...
		if(dir.exists() == false) {	
			...
			System.out.println("C:"+ File.separator +"storage 제거 완료");
		}
